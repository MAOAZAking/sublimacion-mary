...
El sistema incluye un firewall de aplicaciones a nivel de Express para proteger archivos sensibles.
...
## Para ejecutar el Node.js en terminal agregar este comando
    ...
    node server.js
    ```
# Para agregarr todos los cambios github y sobreescribir
    ```bash
    git fetch --all
